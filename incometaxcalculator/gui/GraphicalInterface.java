    ...
    btnLoadTaxpayer.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (answer == 0) {
          ...
          while(answer == 0 && filename.endsWith("_INFO.txt") == false && filename.endsWith("_INFO.xml") == false) {
            JOptionPane.showMessageDialog(null,
                "The file must end with _INFO.txt or _INFO.xml.\n" + " Try again.");
            answer = chooser.showOpenDialog(null);
          }
          //String taxRegistrationNumber = taxRegistrationNumberField.getText();
          String taxRegistrationNumber = filename.substring(0, filename.length() - 9);
          ...
          while (taxRegistrationNumber.length() != 9 && answer == 0) {
            ...
            taxRegistrationNumber = filename.substring(0, filename.length() - 9);
          }
          if (answer == 0) {
            int trn = 0;
            ...
            try {
              ...
              taxRegistrationNumberFile = filename;
      ...
      public void actionPerformed(ActionEvent e) {
        if (taxpayerManager.containsTaxpayer()) {
          if(taxRegisterNumberList.getSelectedIndex() >= 0) {
            ...
            JOptionPane.showMessageDialog(null, "There is no registration number selected.");
          }
      ...
      public void actionPerformed(ActionEvent arg0) {
        if (taxpayerManager.containsTaxpayer()) {
          if(taxRegisterNumberList.getSelectedIndex() >= 0) {
            ...
            taxRegisterNumberModel.removeElement(taxRegisterNumberList.getSelectedValue());
